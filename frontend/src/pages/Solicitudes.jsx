                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2">
                                                <p className="font-bold text-gray-800">{s.celular || s.telefono || 'Sin celular'}</p>
                                                {(s.celular || s.telefono) && (
                                                <a 
                                                    href={`https://wa.me/${(s.celular || s.telefono || '').replace(/\D/g, '')}`} 
                                                    target="_blank" 
                                                    rel="noreferrer"
                                            ...
                                            <p className="text-xs text-gray-500">{s.correo || s.email || 'Sin correo'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="font-medium text-gray-800 text-sm">
                                                {(s.created_at || s.createdAt || s.fecha) ? format(new Date(s.created_at || s.createdAt || s.fecha), 'dd MMM, hh:mm a') : 'Desconocido'}
                                            </p>
                                        </div>
                                    </div>
                                </div>
