...
CUNDINAMARCA-S.ANTONIO TEQUENDAMA
...
NORTE SANTANDER-ARBOLEDAS
NORTE SANTANDER-BOCHALEMA
NORTE SANTANDER-BUCARASICA
NORTE SANTANDER-CACHIRA
NORTE SANTANDER-CACOTA
NORTE SANTANDER-CHINACOTA
NORTE SANTANDER-CHITAGA
NORTE SANTANDER-CONVENCION
NORTE SANTANDER-CUCUTA
NORTE SANTANDER-CUCUTILLA
NORTE SANTANDER-DURANIA
NORTE SANTANDER-EL CARMEN
NORTE SANTANDER-EL TARRA
NORTE SANTANDER-EL ZULIA
NORTE SANTANDER-GRAMALOTE
NORTE SANTANDER-HACARI
NORTE SANTANDER-HERRAN
NORTE SANTANDER-LA PLAYA
NORTE SANTANDER-LABATECA
NORTE SANTANDER-LOS PATIOS
NORTE SANTANDER-LOURDES
NORTE SANTANDER-MUTISCUA
NORTE SANTANDER-OCA#A
NORTE SANTANDER-PAMPLONA
NORTE SANTANDER-PAMPLONITA
NORTE SANTANDER-RAGONVALIA
NORTE SANTANDER-SALAZAR
NORTE SANTANDER-SAN CALIXTO
NORTE SANTANDER-SAN CAYETANO
NORTE SANTANDER-SANTIAGO
NORTE SANTANDER-SARDINATA
NORTE SANTANDER-SILOS
NORTE SANTANDER-TEORAMA
NORTE SANTANDER-TIBU
NORTE SANTANDER-TOLEDO
NORTE SANTANDER-VILLA CARO
NORTE SANTANDER-VILLA DEL ROSARIO
PUTUMAYO-COLON
PUTUMAYO-MOCOA
PUTUMAYO-ORITO
...
async function seed() {
    try {
        ...
        console.log(`Processing ${lines.length} municipalities...`);
        ...
        for (const line of lines) {
            ...
            const existing = await Municipio.findOne({ nombre: line });
            if (existing) {
                skippedCount++;
                continue;
            }
            ...
            // Create new
            // Separation of Department and City is optional if name is the bridge
